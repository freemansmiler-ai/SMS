...
function PrincipalApprovalsContent() {
  ...
  useEffect(() => {
    loadData();
  }, [statusFilter, classFilter, subjectFilter, teacherFilter]);
    ...
    <div className="space-y-5">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
            Headmaster review portal for approving, returning, or publishing teacher marksheets.
          </p>
        </div>
        ...
        <CardContent className="p-3 sm:p-4 flex flex-col sm:flex-row items-center justify-between gap-3">
          <div className="flex flex-wrap items-center gap-3 w-full">
            ...
            <div className="flex items-center gap-1.5 text-xs">
              <span className="font-semibold text-slate-600 dark:text-slate-400">Lifecycle Status:</span>
              <select
                value={statusFilter}
      ...
      <Card className="border-slate-200/80 dark:border-slate-800">
        <CardHeader className="p-4 pb-3">
          <CardTitle className="text-sm font-semibold">Executive Marksheets Queue</CardTitle>
          <CardDescription className="text-xs">
            Showing {batches.length} marksheets matching selected status filter.
          </CardDescription>
        </CardHeader>
          ...
          {loading ? (
            ...
            <div className="p-8">
              <EmptyState
                ...
                description="No marksheets currently match the selected status or subject filter."
              />
            </div>
          ) : (
                    ...
                    <TableRow key={batch.id}>
                      ...
                      <TableCell>
                        {batch.status === "published" ? (
                          <Badge variant="success" className="text-[10px] gap-1 bg-purple-600 text-white">
