        ...
        <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          <div>
            ...
            <p className="text-xs text-slate-500 dark:text-slate-400 mt-0.5">
              Compose and broadcast official notices to faculty teachers, students, or specific classes.
            </p>
          </div>
        ...
        {loading ? (
          ...
          <div className="p-8">
            <EmptyState
              ...
              description="No official notices match the selected target audience."
            />
          </div>
        ) : (
          <div className="space-y-3">
