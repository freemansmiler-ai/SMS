-- ==============================================================================
-- SCHOOL MANAGEMENT SYSTEM - FULL POSTGRESQL DATABASE SCHEMA
...
CREATE INDEX idx_results_status_lookup ON results(school_id, status, student_id);
CREATE INDEX idx_attendance_lookup ON attendance(school_id, class_id, date);
CREATE INDEX idx_attendance_student_date ON attendance(school_id, student_id, date DESC);
